...
export const FULL_RECEIPT_CARD = Dimensions.get('window').height*0.7;
...
export const FULL_RECEIPT_HEIGHT =  Dimensions.get('window').height*0.6;
...
export const FULL_CARD_WIDTH = Dimensions.get('window').width*0.895;
